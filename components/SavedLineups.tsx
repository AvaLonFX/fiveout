...
export default function SavedLineups() {
  ...
  async function remove(id: string) {
    ...
    if (response.ok) { setLineups(items => items.filter(item => item.id !== id)); trackEvent("lineup_removed"); }
