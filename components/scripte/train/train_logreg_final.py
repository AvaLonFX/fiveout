...
def main():
    ...
    ap.add_argument("--out_path", default="models/lr_moneyline_final.joblib")
    ap.add_argument("--model_name", default="lr_moneyline_final")
    ...
    notes = f"Saved: {args.out_path} | features={len(FEATURES_V3)} | scaled logreg"
