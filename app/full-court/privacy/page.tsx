...
export default function PrivacyPage() {
  return <main className="mx-auto max-w-3xl px-5 py-12 text-slate-300">
    ...
    <div className="mt-10 space-y-8 leading-7">
      ...
      <section><h2 className="text-xl font-black text-white">Service usage records</h2><p className="mt-2">To operate and improve Quick Match, FIVEOUT records a random guest or account identifier, match time, era, tactics, and final score when a simulation succeeds. These records do not contain your email address or IP address. A guest identifier is moved to your account if you later sign in.</p></section>
